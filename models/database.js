...
pg.connect(conString, function(err, client, done) {
  ...
  var picsTableQuery = "CREATE TABLE pics(id SERIAL PRIMARY KEY, username VARCHAR(50) NOT NULL, picture VARCHAR(100) NOT NULL, location VARCHAR(50), likes SMALLINT)";
